...
用法：
    python RAG/test_lad_import.py
    python RAG/test_lad_import.py  <xml路径>   # 也可命令行传入
"""
...
# 默认测试的 XML 文件路径
DEFAULT_XML = os.path.join(os.path.dirname(__file__), 'templates', 'application', '报警.xml')


def main(xml_path: str) -> None:
    from openness.tia_core import start_tia_portal, create_project, save_project
